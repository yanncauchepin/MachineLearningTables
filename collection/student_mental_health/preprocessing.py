...
def data_cleaning_specific (input_path) :
    ...
    # Inplace = True to modifies the original DataFrame in place
...
if __name__ == '__main__':
    ...
    input_path = "dataset/studentmentalhealth.csv"
    df = data_cleaning_specific (input_path)
